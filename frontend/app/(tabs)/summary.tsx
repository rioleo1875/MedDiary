  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      ...
      if (supported) {
        ...
        console.log('Summary: Cannot open URL, trying direct fetch...');
        // Fallback: try to verify the API works
        ...
        if (response.ok) {
          Alert.alert("Success", "PDF generated successfully! Check your browser downloads.");
        } else {
